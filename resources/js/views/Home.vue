<template>
  <div>
    <section class="section content">
      ...
      <p>
        Sign up if you're interested in saving your text blurbs, and to take advantage of future features. These include:
        <ul>
    ...
    <memorize-tool></memorize-tool>
  </div>
</template>

<script>
import MemorizeTool from '../components/App-MemorizeTool.vue'

export default {
  name: 'App',
  components: { MemorizeTool }
}
</script>
