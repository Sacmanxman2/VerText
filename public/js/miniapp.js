...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_App_MemorizeTool__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_App_MemorizeTool___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_App_MemorizeTool__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_buefy__ = __webpack_require__(23);
...
var miniapp = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  el: '#miniapp',
  render: function render(h) {
    return h(__WEBPACK_IMPORTED_MODULE_1__components_App_MemorizeTool___default.a);
  }
});
...
Component.options.__file = "resources/js/components/App-MemorizeTool.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4272c24b", Component.options)
  } else {
    hotAPI.reload("data-v-4272c24b", Component.options)
  }
...
var update = __webpack_require__(12)("b5ebe39c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4272c24b\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./App-MemorizeTool.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4272c24b\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./App-MemorizeTool.vue");
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mixins_processTheStrings__ = __webpack_require__(84);


/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'MemorizeTool',
  mixins: [__WEBPACK_IMPORTED_MODULE_0__mixins_processTheStrings__["a" /* default */]],
  data: function data() {
    return {
      inputText: '',
      underlineMode: true
    ...
    outputText: function outputText() {
      ...
      if (this.inputText) {
        if (this.inputText.length > 5000) {
          return ['Yikes, that\'s a lot of text (' + this.numbersWithCommas(this.inputText.length) + ' characters)! Try breaking it into smaller chunks.', "", "Alternatively, you could sign up and take advantage of our chunking feature!"];
        }
        var lines = this.inputText.split('\n');
        var linesArray = lines.map(function (line) {
          if (_this.underlineMode) {
            return _this.process(line);
          } else {
            return _this.process(line).replace(/_/g, '');
          }
        });
        return linesArray;
      } else {
        ...
        _c(
          ...
          [
            _c(
              ...
              {
                model: {
                  value: _vm.underlineMode,
                  callback: function($$v) {
                    _vm.underlineMode = $$v
                  },
                  expression: "underlineMode"
                }
              },
              [_vm._v("Underline rest of word")]
            )
          ],
          1
        ),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4272c24b", module.exports)
  }
}
...
/* harmony default export */ __webpack_exports__["a"] = ({
  name: 'processIt',
  methods: {
    process: function process(inputstring) {
      var outputstring = '';
      var ISSplitted = inputstring.split('');
      var ISLength = ISSplitted.length;
      for (var i = 0; i < ISLength; i++) {
        var currentISChar = ISSplitted[i];
        var nextISChar = void 0;
        var prevISChar = void 0;
          ...
          if (currentISChar.match(/[.?!;,]/)) {
            ...
            if (!prevISChar.match(/[.?!;\s]/)) {
              if (prevISChar.match(/['"]/)) {
                ...
                if (i > 1) {
                  // Ok, we can, so lets see if the char 2 items back is a letter.
                  var prev2ISChar = ISSplitted[i - 2];
                  if (!prev2ISChar.match(/[.?!;\s]/)) {
                    // previous char is not one of our word separators, therefore it must be a letter and part of a word.
                    outputstring += '_';
                  } else {
                    outputstring += currentISChar;
                  }
    ...
    numbersWithCommas: function numbersWithCommas(x) {
      x = x.toString();
      var pattern = /(-?\d+)(\d{3})/;
